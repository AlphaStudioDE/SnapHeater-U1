...
Current status: UI prototype with mock firmware data. BLE integration will be added after hardware validation confirms the final GATT contract and payload details.
