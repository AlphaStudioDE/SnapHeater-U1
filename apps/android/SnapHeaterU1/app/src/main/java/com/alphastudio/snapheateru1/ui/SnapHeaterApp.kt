...
private val HeaterSnapshotSaver = listSaver<HeaterSnapshot, Any>(
    ...
    restore = { values ->
        HeaterSnapshot(
            ...
            heaterLocked = values[6] as Boolean,
            ...
            heatSoakEnabled = values[13] as Boolean,
            virtualDoorDetectionEnabled = values[14] as Boolean,
            autoMaterialProfileEnabled = values[15] as Boolean,
            mismatchWarningEnabled = values[16] as Boolean,
            plaProtectionEnabled = values[17] as Boolean,
            antiWarpEnabled = values[18] as Boolean,
            largePrintProtectionEnabled = values[19] as Boolean,
            safeOvernightEnabled = values[20] as Boolean,
            pauseHoldEnabled = values[21] as Boolean,
            smartResumeEnabled = values[22] as Boolean,
            startPrintWarningEnabled = values[23] as Boolean,
            airflowDetectionEnabled = values[24] as Boolean,
            tempHistoryEnabled = values[25] as Boolean,
            incidentReportEnabled = values[26] as Boolean,
            localRecipesEnabled = values[27] as Boolean,
            scheduledPreheatEnabled = values[28] as Boolean,
            localOnlyMode = values[29] as Boolean,
            demoModeEnabled = values[30] as Boolean,
            showcaseModeEnabled = values[31] as Boolean,
            symbiontModeEnabled = values[32] as Boolean,
            symbiontVentilationAllowed = values[33] as Boolean,
        )
    },
)
