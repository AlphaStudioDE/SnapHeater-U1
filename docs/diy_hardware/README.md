...
The default firmware target leaves physical outputs unmapped. DIY builders must set GPIOs to match their own low-voltage wiring and then follow the unlock procedure.
